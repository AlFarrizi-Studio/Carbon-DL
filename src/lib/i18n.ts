...
const partial: Record<string, Partial<Strings>> = {
  sv: {grab: 'ladda ner', quit: 'avsluta', cancel: 'avbryt', tip: 'Tips', lblTitle: 'Titel', lblArtist: 'Artist', lblAlbum: 'Album', lblRelease: 'Släpp', lblTime: 'Längd', lblSource: 'Källa'},
  ...
  fi: {grab: 'lataa', quit: 'poistu', cancel: 'peruuta', tip: 'Vinkki', lblTitle: 'Otsikko', lblArtist: 'Artisti', lblAlbum: 'Albumi', lblRelease: 'Julkaisu', lblTime: 'Kesto', lblSource: 'Lähde'},
  cs: {grab: 'stáhnout', quit: 'ukončit', cancel: 'zrušit', tip: 'Tip', lblTitle: 'Název', lblArtist: 'Umělec', lblAlbum: 'Album', lblRelease: 'Vydání', lblTime: 'Délka', lblSource: 'Zdroj'},
  sk: {grab: 'stiahnuť', quit: 'ukončiť', cancel: 'zrušiť', tip: 'Tip', lblTitle: 'Názov', lblArtist: 'Umelec', lblAlbum: 'Album', lblRelease: 'Vydanie', lblTime: 'Trvanie', lblSource: 'Zdroj'},
  hu: {grab: 'letöltés', quit: 'kilépés', cancel: 'mégse', tip: 'Tipp', lblTitle: 'Cím', lblArtist: 'Előadó', lblAlbum: 'Album', lblRelease: 'Kiadás', lblTime: 'Hossz', lblSource: 'Forrás'},
  ...
  et: {grab: 'laadi alla', quit: 'välju', cancel: 'tühista', tip: 'Vihje', lblTitle: 'Pealkiri', lblArtist: 'Esitaja', lblAlbum: 'Album', lblRelease: 'Väljalase', lblTime: 'Kestus', lblSource: 'Allikas'},
  ca: {grab: 'descarrega', quit: 'surt', cancel: 'cancel·la', tip: 'Consell', lblTitle: 'Títol', lblArtist: 'Artista', lblAlbum: 'Àlbum', lblRelease: 'Llançament', lblTime: 'Durada', lblSource: 'Font'},
  ...
  gl: {grab: 'descargar', quit: 'saír', cancel: 'cancelar', tip: 'Consello', lblTitle: 'Título', lblArtist: 'Artista', lblAlbum: 'Álbum', lblRelease: 'Lanzamento', lblTime: 'Duración', lblSource: 'Fonte'},
  is: {grab: 'sækja', quit: 'hætta', cancel: 'hætta við', tip: 'Ábending', lblTitle: 'Titill', lblArtist: 'Listamaður', lblAlbum: 'Plata', lblRelease: 'Útgáfa', lblTime: 'Lengd', lblSource: 'Uppruni'},
  ga: {grab: 'íoslódáil', quit: 'scoir', cancel: 'cealaigh', tip: 'Leid', lblTitle: 'Teideal', lblArtist: 'Ealaíontóir', lblAlbum: 'Albam', lblRelease: 'Eisiúint', lblTime: 'Fad', lblSource: 'Foinse'},
  ...
  sq: {grab: 'shkarko', quit: 'dil', cancel: 'anulo', tip: 'Këshillë', lblTitle: 'Titulli', lblArtist: 'Artisti', lblAlbum: 'Albumi', lblRelease: 'Lëshimi', lblTime: 'Kohëzgjatja', lblSource: 'Burimi'},
  ...
  lb: {grab: 'eroflueden', quit: 'verloossen', cancel: 'ofbriechen', tip: 'Tipp', lblTitle: 'Titel', lblArtist: 'Kënschtler', lblAlbum: 'Album', lblRelease: 'Verëffentlechung', lblTime: 'Dauer', lblSource: 'Quell'},
  ...
  az: {grab: 'yüklə', quit: 'çıxış', cancel: 'ləğv et', tip: 'Məsləhət', lblTitle: 'Başlıq', lblArtist: 'İfaçı', lblAlbum: 'Albom', lblRelease: 'Buraxılış', lblTime: 'Müddət', lblSource: 'Mənbə'},
  ...
  tk: {grab: 'ýükle', quit: 'çyk', cancel: 'ýatyr', tip: 'Maslahat', lblTitle: 'Ady', lblArtist: 'Artist', lblAlbum: 'Albom', lblRelease: 'Çykyş', lblTime: 'Dowamlylygy', lblSource: 'Çeşme'},
  ...
  ku: {grab: 'daxistin', quit: 'derketin', cancel: 'betal', tip: 'Şîret', lblTitle: 'Sernav', lblArtist: 'Hunermend', lblAlbum: 'Albûm', lblRelease: 'Weşan', lblTime: 'Dem', lblSource: 'Çavkanî'},
  ...
  ht: {grab: 'telechaje', quit: 'soti', cancel: 'anile', tip: 'Konsèy', lblTitle: 'Tit', lblArtist: 'Atis', lblAlbum: 'Album', lblRelease: 'Lage', lblTime: 'Dire', lblSource: 'Sous'},
  ...
  ln: {grab: 'kokitisa', quit: 'kobima', cancel: 'kotika', tip: 'Toli', lblTitle: 'Motó', lblArtist: 'Moyembi', lblAlbum: 'Album', lblRelease: 'Bimisa', lblTime: 'Ntango', lblSource: 'Esika'},
